                        ...
                        function draw() {
                                ...
                                var query = new google.visualization.Query('https://docs.google.com/a/bbva.com/spreadsheet/ccc?key=0AiFNgwhcmeiHdEFibmNyYWZxaVljM2NjdFEzbEQtN0E#gid=0');
                        ...
                        function handleQueryResponse(response) {
                                ...
                                for (var row = 0; row < data.getNumberOfRows(); row++) {
                                        ...
                                        if ((data.getValue(row, column_estado)).toLowerCase().indexOf('en cartera') == -1
											...
											&& (data.getValue(row, column_estado)).toLowerCase().indexOf('cancelado') == -1
