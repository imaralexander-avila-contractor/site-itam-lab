...
function draw() {
	...
	// https://docs.google.com/spreadsheets/d/1RpmpKCiIsaE9Kyk6xHfIyPDARlMHiHvpPXtLCwu3qXQ/edit#gid=1871223754
	
	var query = new google.visualization.Query('https://docs.google.com/spreadsheets/d/1RpmpKCiIsaE9Kyk6xHfIyPDARlMHiHvpPXtLCwu3qXQ/edit#gid=1871223754');
...
function handleQueryResponse(response) {
		...
		// data.removeRow(0); // <j.schroeder> 201505061510 Se comenta porque no aparece el renglÃ³n 1 dentro de la pÃ¡gina del site
